...
class Razorpay
{
    ...
    public function view()
    {
        if (Session::has('razorpay_credentials')) {
            ...
            if (Session::get('is_user_subscription')){
                return view('frontend.payment.subscriptions.payment.razorpay', compact('Info', 'gateway', 'plan', 'response'));
            }elseif(Session::get('is_admin_subscription')){
                return view('user.subscriptions.payment.razorpay', compact('Info', 'gateway', 'plan', 'response'));
            }
