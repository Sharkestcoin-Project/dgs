    ...
    public function view()
    {
        if (Session::has('paystack_credentials')) {
            ...
            if (Session::get('is_user_subscription')){
                return view('frontend.payment.subscriptions.payment.paystack', compact('Info', 'gateway', 'plan'));
            }elseif(Session::get('is_admin_subscription')){
                return view('user.subscriptions.payment.paystack', compact('Info', 'gateway', 'plan'));
            }
