                            ...
                            <div class="px-4">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>
                                            {{ currency_format(convert_money($plan->price, $plan->currency)) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>{{ __('Total') }}</th>
                                        <td>{{ currency_format(convert_money($plan->price, $plan->currency) + calculate_gateway_charge($gateway)) }}</td>
                                    </tr>
                                    ...
                                    @if(Session::has('promotion'))
                                        <tr>
                                            ...
                                            <td>
                                                {{ $promotion->is_percent ? currency_format((convert_money($plan->price, $plan->currency) * $promotion->discount) / 100) : currency_format($promotion->discount) }}
                                            </td>
                                        </tr>
                                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                if (Session::has('promotion')){
                                                   $discount = $promotion->is_percent ? (convert_money($plan->price, $plan->currency) * $promotion->discount) / 100 : $promotion->discount;
                                                }else{
                                                    $discount = 0;
                                                }
                                            @endphp
                                            {{ currency_format(payable(convert_money($plan->price, $plan->currency) - $discount, $gateway, true), 'icon', $gateway->currency->symbol) }}
                                        </td>
                                    </tr>
                                    <tr>
