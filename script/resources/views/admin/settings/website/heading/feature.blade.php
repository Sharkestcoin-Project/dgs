                ...
                <div class="tab-pane fade {{ $i == 0 ? 'active' : null }} show" id="{{ $key }}-feature" role="tabpanel" aria-labelledby="{{ $key }}-feature-tab">
                    <form class="ajaxform" action="{{ route('admin.settings.website.heading.update-feature') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="button_text" id="button_text" class="form-control" value="{{ $headings['heading.feature'][$key]['button_text'] ?? null }}" required>
                        </div>

                        <div class="form-group">
                            <label for="button_url" class="required">{{ __('Button Url') }} ({{ $key }})</label>
                            <input type="text" name="button_url" id="button_url" class="form-control" value="{{ $headings['heading.feature'][$key]['button_url'] ?? null }}" required>
                        </div>
