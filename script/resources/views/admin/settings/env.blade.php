                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#MailChimp" role="tab" aria-controls="driver" aria-selected="false">{{ __('MailChimp') }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#memcached" role="tab" aria-controls="driver" aria-selected="false">{{ __('Memcached Settings (Cache Driver)') }}</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                            <form enctype="multipart/form-data" method="post" class="ajaxform" action="{{ route('admin.env.store') }}">
                                @csrf
                        <div class="tab-content no-padding" id="myTab2Content">
                            <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('CONTENT_EDITOR') }}</label>
                                    <select class="form-control" name="CONTENT_EDITOR">
                                        <option value="true" @if(env('CONTENT_EDITOR') == true) selected @endif>true</option>
                                        <option value="false" @if(env('CONTENT_EDITOR') == false) selected @endif>false</option>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="driver" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="CACHE_DRIVER">
                                        ...
                                        <option value="file" @if(env('CACHE_DRIVER') == 'file') selected="" @endif>{{ __('File') }}</option>
                                        ...
                                        <option value="redis" @if(env('CACHE_DRIVER') == 'redis') selected="" @endif>{{ __('Redis  (Dont Enable If You Dont Have phpredis Extension)') }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="redis_method" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="REDIS_URL" class="form-control" value="{{ env('REDIS_URL') }}">
                                </div>
                            ...
                            <div class="tab-pane fade" id="MailChimp" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('MAILCHIMP_DRIVER') }}</label>
                                    <input type="text"  name="MAILCHIMP_DRIVER" class="form-control" value="{{ env('MAILCHIMP_DRIVER') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('MAILCHIMP_API KEY') }}</label>
                                    <input type="text"  name="MAILCHIMP_APIKEY" class="form-control" value="{{ env('MAILCHIMP_APIKEY') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('MAILCHIMP_LIST_ID') }}</label>
                                    <input type="text"  name="MAILCHIMP_LIST_ID" class="form-control" value="{{ env('MAILCHIMP_LIST_ID') }}">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="storage" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <hr>
                                <p>{{ __('Fill up this credentials if you want to use AWS S3 Storage Bucket') }}</p>
                                <div class="form-group">
                                    <label>{{ __('AWS_ACCESS_KEY_ID') }}</label>
                                    <input type="text"  name="AWS_ACCESS_KEY_ID" class="form-control" value="{{ env('AWS_ACCESS_KEY_ID') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('AWS_SECRET_ACCESS_KEY') }}</label>
                                    <input type="text"  name="AWS_SECRET_ACCESS_KEY" class="form-control" value="{{ env('AWS_SECRET_ACCESS_KEY') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('AWS_DEFAULT_REGION') }}</label>
                                    <input type="text"  name="AWS_DEFAULT_REGION" class="form-control" value="{{ env('AWS_DEFAULT_REGION') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('AWS_BUCKET') }}</label>
                                    <input type="text"  name="AWS_BUCKET" class="form-control" value="{{ env('AWS_BUCKET') }}">
                                </div>
                                 <hr>
                                 <p>{{ __('Fill up this credentials if you want to use Wasabi Storage Bucket') }}</p>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="WAS_SECRET_ACCESS_KEY" class="form-control" value="{{ env('WAS_SECRET_ACCESS_KEY') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="memcached" role="tabpanel" aria-labelledby="profile-tab4">
                                <h6>Memcached Settings (Cache Driver)</h6>


                                <div class="form-group">
                                    <label>{{ __('MEMCACHED_HOST') }}</label>
                                    <input type="text"  name="MEMCACHED_HOST" class="form-control" value="{{ env('MEMCACHED_HOST') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('MEMCACHED_PORT') }}</label>
                                    <input type="text"  name="MEMCACHED_PORT" class="form-control" value="{{ env('MEMCACHED_PORT') }}">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('MEMCACHED_PERSISTENT_ID (optional)') }}</label>
                                    <input type="text"  name="MEMCACHED_PERSISTENT_ID" class="form-control" value="{{ env('MEMCACHED_PERSISTENT_ID') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('MEMCACHED_USERNAME (optional)') }}</label>
                                    <input type="text"  name="MEMCACHED_USERNAME" class="form-control" value="{{ env('MEMCACHED_USERNAME') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('MEMCACHED_PASSWORD (optional)') }}</label>
                                    <input type="text"  name="MEMCACHED_PASSWORD" class="form-control" value="{{ env('MEMCACHED_PASSWORD') }}">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="mail_configuration" role="tabpanel" aria-labelledby="profile-tab4">
                                <div class="form-group">
                                    ...
                                    <select name="QUEUE_MAIL" id="QUEUE_MAIL" class="form-control">
                                        <option value="true" @selected(config('system.queue.mail') == true)>{{ __('true') }}</option>
                                        <option value="false" @selected(config('system.queue.mail') == false)>{{ __('false') }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="MAIL_DRIVER" class="form-control">
                                        <option value="sendmail" @selected(config('mail.default') == 'sendmail')>{{ __('sendmail') }}</option>
                                        <option value="smtp" @selected(config('mail.default') == 'smtp')>{{ __('smtp') }}</option>
                                        <option value="mailgun" @selected(config('mail.default') == 'mailgun')>{{ __('mailgun') }}</option>
                                        <option value="mandrill" @selected(config('mail.default') == 'mandrill')>{{ __('mandrill') }}</option>
                                        <option value="ses" @selected(config('mail.default') == 'ses')>{{ __('ses') }}</option>
                                        <option value="sparkpost" @selected(config('mail.default') == 'sparkpost')>{{ __('sparkpost') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"   name="MAIL_PASSWORD" class="form-control" value="{{ env('MAIL_PASSWORD') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"   name="MAIL_TO" class="form-control" value="{{ env('MAIL_TO') }}">
                                </div>
