    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('admin.medias.delete') }}" method="POST" class="ajaxform_with_mass_delete">
                            @csrf
                            <div class="card-body">
                                <div class="float-left">
                                    <div class="input-group mb-3">
                                        <select class="form-control selectric mr-3" tabindex="-1" name="status" aria-describedby="submit-button">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="custom-checkbox custom-control">
                                                        <input type="checkbox" data-checkboxes="mygroup" name="id[]" class="custom-control-input checked_input" value="{{ $media->id }}" id="media-{{ $media->id }}">
