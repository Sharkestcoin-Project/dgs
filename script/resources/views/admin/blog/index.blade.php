...
<div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
            <form method="post" action="{{ route('admin.blog.delete-all') }}" class="ajaxform_with_mass_delete">
                @csrf
               ...
               <div class="table-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                      <td> <input type="checkbox" class="checked_input" name="ids[]" value="{{ $row->id }}"></td>
                      <td>{{$key+1}}</td>
                    <td>{{ $row->title }}</td>
