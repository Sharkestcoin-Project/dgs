                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="currency_id" id="currency_id" class="form-control" required>
                                        ...
                                        <option @selected($payoutmethod->currency_id == $currency->id) value="{{ $currency->id }}">{{ $currency->name. " (".$currency->rate.")" }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="transaction_fixed col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="delay" value="{{ $payoutmethod->delay }}" placeholder="{{ __('Delay') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="charge_type" class="form-control" id="charge_type">
                                ...
                                <option {{ $payoutmethod->fixed_charge != null ? 'selected' : '' }}  value="fixed">{{ __('Fixed') }}  </option>
                                <option {{ $payoutmethod->percent_charge != null ? 'selected' : '' }} value="percentage">{{ __('Percentage') }}  </option>
                            </select>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="transaction_fixed col-sm-12 d-none" >
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{$payoutmethod->fixed_charge}}" name="fixed_charge" placeholder="{{ __('Fixed Amount') }}">
                                </div>
                            </div>
                            ...
                            <div class="transaction_percentage col-sm-12 d-none" >
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{$payoutmethod->percent_charge}}" name="percent_charge" placeholder="{{ __('Percentage Amount') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="btn-publish">
                                <button type="submit" class="btn btn-primary col-12 basicbtn"><i class="fa fa-save"></i> {{ __('Save') }}
                                </button>
                            </div>
                        </div>
                    </div>
